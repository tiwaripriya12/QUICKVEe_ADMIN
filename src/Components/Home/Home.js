...
const Home = () => {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 right-0 z-50 bg-white transition-all duration-300 h-24 shadow-md border-b-4 border-black ${
          isSticky ? '' : ''
        }`}
      >
        <div className='flex items-center m-2 p-2'>
          ...
          <div className='ml-auto font-circular flex items-center text-base text-black'>
            ...
            <p className='cursor-pointer ml-2 mr-4 font-semibold Admin_std'>Download App</p>
          </div>

          <div className='ml-8 font-circular flex items-center text-base text-black'>
            <BiShow className='ml-2' />
            <p className='cursor-pointer ml-2 mr-4 font-semibold Admin_std'>Online Store</p>
            <BiSync className='ml-2' />
            <p className='cursor-pointer ml-2 font-semibold Admin_std'>Sync Data</p>
          </div>
