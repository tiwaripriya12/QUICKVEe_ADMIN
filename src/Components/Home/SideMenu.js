...
const DropdownMenuItem = ({ item }) => {
  ...
  return (
    <div className='flex items-center'> {/* mt-4 and mb-4 apply equal top and bottom margins */}
    {/* Your existing menu code */}
    {item.icon}
    <p className='ml-2 cursor-pointer menu-item text-gray-400  ' onClick={toggleDropdown}>
...
const menuItems = [
   {
    id: 1,
    icon: <img src={DashboardIcon} alt="Dashboard" className="h-6 w-6 mt-4 mb-4" />,
    text: 'Dashboard',
    link: '/dashboard',
  },
  {
  ...
  {
    id: 3,
    icon: <img src={CategoryIcon} alt="Category" className='h-6 w-6 mt-4 mb-4' />,
    text: 'Category',
    link: '/category',
  },
  {
    id: 4,
    icon: <img src={ProductIcon} alt="Products" className='h-6 w-6 mt-4 mb-4' />,
    text: 'Products',
    link: '/products',
  },
  {
  ...
  {
    id: 6,
    icon: <img src={PurchaseIcon} alt="Purchase Data" className='h-6 w-6 mt-4 mb-4' />,
    text: 'Purchase Data',
    link: '/purchase-data',
  },
  {
    id: 7,
    icon: <img src={DataIcon} alt="Import Data" className='h-6 w-6 mt-4 mb-4' />,
    text: 'Import Data',
    link: '/import-data',
  },
  {
