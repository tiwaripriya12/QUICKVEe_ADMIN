...
<div className="flex flex-col md:flex-row mb-9">
  ...
  <div className="md:w-2/3 sm:">
    <div className="flex flex-row text-gray-600 space-x-4 py-2 bg-[#F5F5F5] mr-4">
...
<div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 items-start">
      ...
      <div className="relative">
        ...
        <div className='w-full'>
          <DatePicker
            ...
            className="border border-blue-500 rounded px-3 py-2 pr-10 mt-1 focus:outline-none focus:border-blue-500 w-80"
            ref={startDateRef}
          />
      ...
      <div className='mt-6'>
        {/* Search Button */}
        <button onClick={handleSearch} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline self-start mt-8">
          Search
        </button>
      </div>
    </div>
