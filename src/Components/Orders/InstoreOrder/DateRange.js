...
const DateRange = () => {
  ...
  const handleSearch = () => {
    // Perform search or filter functionality here using startDate and endDate
    console.log('Searching...');
  };
  return (
    <>
    <div className='mx-[-2rem]'>
  <div className="box-content h-[200px] w-70 p-4 border-4 border-white bg-white rounded-xl opacity-100 mt-7 mx-4" style={{ boxShadow: "0px 3px 6px #0000001F" }}>
  ...
  {/* Search Button */}
  <button onClick={handleSearch} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline self-start mt-5">
    Search
  </button>
</div>
      </div>
